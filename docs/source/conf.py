...
try:
    version = get_distribution(PROJECT_NAME_LOWER).version
    release = version
except Exception as error:
    print("WARNING: cannot find PROJECT_NAME_UPPER version")
    version = "Unknown"
    release = version
...
# Title
html_title = "PROJECT_NAME_UPPER Documentation"
html_short_title = "PROJECT_NAME_UPPER Documentation"
